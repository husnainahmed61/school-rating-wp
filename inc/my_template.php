...
<div class="row" id="search">
	<div class="col-sm-12 col-sm-offset-4">
		<div id="search_div">
            ...
            <form method="post" action="<?=get_site_url();?>/schulen">
                <input type="text" placeholder="Stadt oder Name" id="example-ajax-post" name="search_query" autofocus style="
    font-size: 18px;
font-weight: 600;
...
margin-left: -54px;"/>
<?php //print_r(site_url()); ?>
                <input type="submit" value="Suchen" style="background-color: #000000;
    color: #ffffff;
    font-size: 18px;
    font-weight: 600;
    text-transform: uppercase;
...
<input type="submit" value="Zurück" class="back_button" style="display: none;">
            <script type="text/javascript">
// var options = {

//   url: function(phrase) {
//     return "<?=WPAC_PLUGIN_DIR . 'inc/get_schools.php' ?>";
//   },
...
// jQuery("#example-ajax-post").easyAutocomplete(options);

      //       	jQuery( "#caregiver-sub-category" ).change(function() {
      //       		var singleValues = jQuery( "#caregiver-sub-category" ).val();
				  // //alert(singleValues );

				  // var submit = 'submit';
      //   			jQuery.ajax({
		    //         type : "post",
		    //         url : "<?php //echo WPAC_PLUGIN_DIR . 'inc/filter_data.php' ?>",
		    //         data : {
            ...
            if (user_email == '') 
            {
			  ...
			  var submit = 'submit';
	            ...
	            success: function(res) {
                	...
                	alert(res);                
	                var delay = 1000; 
                    var URL = "https://gradeyourschool.at/schulen/";
...
$('#input-1').on('rating.change', function() {
	...
	//var filled = jQuery(".filled-stars").attr("width").val();
            //alert("The selected rating is: " + $('#input-1').val());
...
<div class="row target" style="cursor: pointer;"  data_id="<?=$value->id?>">
    <div class="col-sm-12">
    <div class="card mb-3" >
  <div class="row no-gutters">
    <div class="col-md-4">
      <img src="<?=$value->school_image;?>" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        ...
        <span class="float-right"><i class="text-warning fa fa-star"></i></span>
        <span class="float-right"><i class="text-warning fa fa-star"></i></span> -->
        <h2 class="card-title"><?=$value->school_name;?></h2>

        <p class="card-text">Type Of School : <?=$value->type_of_school;?></p>
        <p class="card-text"><small class="text-muted">address :  <?=$value->school_Address;?></small></p>
      </div>
    </div>
...
<div id="rating_div" class="value_id" style="display: none;">
	<div class="container">
        <div class="row">
            <div class="col-sm-12 col-sm-offset-4" >
                <div class="form-group">
                  ...
                  <input type="text" class="col-sm-4" name="user_email" id="user_email" placeholder="Email...">
                </div>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
                    <h3 for="comment" style="text-align: center;"><b>Lehrerkollegium:</b></h3>
				  <textarea  class="form-control" rows="5" id="comment1" placeholder="Lehrerkollegium"></textarea>
				</div>
				<input id="input-1" type="number" name="input-1" class="rating rating-loading" data-min="0" data-max="5" data-step="0.5" value="0">			
			</div>
			<div class="col-sm-6">
				<div class="form-group">
                    <h3 for="comment" style="text-align: center;"><b>Ausstattung / Modernheit:</b></h3>
				  <textarea class="form-control" rows="5" id="comment2" placeholder="Ausstattung / Modernheit"></textarea>
				</div>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group">
                   <h3 for="comment" style="text-align: center;"><b>Freizeitaktivitäten / Angebot:</b></h3>
				  <textarea class="form-control" rows="5" id="comment3" placeholder="Freizeitaktivitäten/Angebot"></textarea>
				</div>
				<input id="input-3" type="number" name="input-1" class="rating rating-loading" data-min="0" data-max="5" data-step="0.5" value="0">			
			</div>
			<div class="col-sm-6">
				<div class="form-group">
                    <h3 for="comment" style="text-align: center;"><b>Cafetaria / Nahrungsangebot:</b></h3>
				  <textarea class="form-control" rows="5" id="comment4" placeholder="Cafetaria / Nahrungsangebot"></textarea>
				</div>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="form-group">
				  <h3 for="comment" style="text-align: center;"><b>Gesamtwertung:</b></h3>
				  <textarea class="form-control" rows="5" id="comment5" placeholder="Gesamtwertung"></textarea>
				</div>
